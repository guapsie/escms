const icons = {
    ...
    plus: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><line x1="40" y1="128" x2="216" y2="128"></line><line x1="128" y1="40" x2="128" y2="216"></line></svg>`,

    columns: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><rect x="40" y="40" width="176" height="176" rx="16"></rect><line x1="128" y1="40" x2="128" y2="216"></line></svg>`,
    grid: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><rect x="40" y="40" width="176" height="176" rx="16"></rect><line x1="128" y1="40" x2="128" y2="216"></line><line x1="40" y1="128" x2="216" y2="128"></line></svg>`,
    button: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><rect x="32" y="72" width="192" height="112" rx="24"></rect></svg>`,
    separator: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><line x1="40" y1="128" x2="216" y2="128"></line></svg>`,
    spacer: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><rect x="40" y="40" width="176" height="176" rx="16" stroke-dasharray="16 16"></rect></svg>`,
    quotes: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><path d="M104,104A32,32,0,0,0,40,104V168h64Z"></path><path d="M216,104a32,32,0,0,0-64,0V168h64Z"></path></svg>`,
    list: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><line x1="104" y1="64" x2="216" y2="64"></line><line x1="104" y1="128" x2="216" y2="128"></line><line x1="104" y1="192" x2="216" y2="192"></line><line x1="40" y1="64" x2="56" y2="64"></line><line x1="40" y1="128" x2="56" y2="128"></line><line x1="40" y1="192" x2="56" y2="192"></line></svg>`,
    code: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><polyline points="64 88 16 128 64 168"></polyline><polyline points="192 88 240 128 192 168"></polyline><line x1="160" y1="40" x2="96" y2="216"></line></svg>`,
    videoCamera: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><rect x="32" y="72" width="136" height="112" rx="16"></rect><polygon points="168 128 224 88 224 168 168 128"></polygon></svg>`,
    speakerHigh: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><polygon points="80 168 32 168 32 88 80 88 136 40 136 216 80 168"></polygon><path d="M192,104a32,32,0,0,1,0,48"></path><path d="M224,72a72,72,0,0,1,0,112"></path></svg>`,
    youtubeLogo: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><rect x="32" y="56" width="192" height="144" rx="32"></rect><polygon points="112 104 160 128 112 152 112 104" fill="currentColor"></polygon></svg>`,
    playCircle: `<svg viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"><circle cx="128" cy="128" r="96"></circle><polygon points="104 88 168 128 104 168 104 88"></polygon></svg>`
};