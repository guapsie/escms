...
**Siguiente paso lógico:** Conectar el Inspector de forma bidireccional: que lea los estilos reales del nodo seleccionado (`window.getComputedStyle`) para poblar los controles, y que al ajustar un control, se actualice el nodo en tiempo real. Después, montar el Árbol de Capas (Layers).
